    ...
    <Grid container item className='container' sm={12} justifyContent='center'>
      <Grid container item sm={8} style={{margin: isDesktop ? '80px 0' : '56px 0'}}>
        ...
        <div>
          ...
          <p style={paragraphStyle}>Phasellus suscipit magna in nibh placerat, vitae viverra mauris sagittis. Aliquam erat volutpat. Integer efficitur sapien tempus maximus blandit. Donec mi risus, dictum vel aliquam eu, mollis eu elit. In hac habitasse platea dictumst. Nulla molestie facilisis quam, eu semper odio interdum condimentum. Praesent ornare ut neque sed suscipit. Curabitur mi enim, lobortis vitae est et, placerat lobortis nisl. Phasellus ligula nibh, aliquam eget ligula et, lacinia egestas arcu.</p>
        </div>

        <div style={sessionStyle}>
          <h4 style={h4Style}>Título h4</h4>
          <p style={paragraphStyle}>Quisque ac faucibus lectus, et dignissim ex. Vestibulum a auctor nibh, in bibendum mi. Fusce consequat ligula libero, eu pretium tortor interdum at. Proin eget mi quis tellus aliquam cursus. Suspendisse et quam non leo bibendum molestie in vitae nunc. Nulla quam dolor, molestie eu dui quis, dictum faucibus arcu. Vivamus suscipit gravida leo, id laoreet leo faucibus at. Donec id bibendum leo.</p>
          <p style={paragraphStyle} className='list'>
