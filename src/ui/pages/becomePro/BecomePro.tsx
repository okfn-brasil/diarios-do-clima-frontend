...
import { green, darkBlue, darkGray, lightGray } from "/src/ui/utils/colors";
      ...
      <Grid container className='container'>
        ...
        <Grid item xs={12} sm={6}>
          ...
          <div style={{ marginTop: '34px', marginBottom: isDesktop ? '141px' : '50px'}}>
            ...
            <Link to={urls.startSearch.url}><ButtonOutlined sx={{...buttonStyle, color: darkGray}}>Continuar sem assinatura</ButtonOutlined></Link>
          </div>
        </Grid>
      </Grid>
    );
