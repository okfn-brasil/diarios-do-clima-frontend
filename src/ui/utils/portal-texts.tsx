    ...
    section: [
      {
        ...
        paragraphs: [
          ...
          <span>1.2. Nesse sentido, as informações disponíveis na plataforma não têm caráter oficial e são mera reprodução do conteúdo publicado por prefeituras em seus respectivos diários oficiais. O acesso a uma parte das informações – oriundas de documentos publicados nos últimos 3 meses – é gratuito, ao passo que o acesso aos resultados de todo o histórico disponível, associado a outras funcionalidades, na modalidade “PRO”, é oferecido <a style={{color: '#52ce5f'}} href="https://staging.diariodoclima.org.br/planos" target="_blank" rel="noopener">mediante assinatura</a>. Além disso, é possível solicitar o serviço de confecção de relatórios, desenvolvidos por especialistas que integram as organizações da coalizão, contendo análises aprofundadas sobre dados extraídos do Diário do Clima. Em todos esses casos, é solicitado que a pessoa usuária faça um breve cadastro (saiba mais abaixo, na seção 2 – Política de Privacidade).</span>
        ]
      }, 
      {
